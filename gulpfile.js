...
gulp.task('scripts', function () {
    return gulp.src([
        ...
        'src/assets/js/vendor/jquery/masked-input.js',
...
gulp.task('default', ['clean:dist', 'font', 'scripts', 'images', 'map', 'compile-html', 'resetPages', 'watch']);

// Creates production ready assets in dist folder
gulp.task('build', function () {
    console.log('Building production ready assets');
    runSequence('clean:dist', 'sass', ['scripts', 'images', 'font', 'map', 'compile-html'])
});
